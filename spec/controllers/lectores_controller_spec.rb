...
describe LectoresController do
  ...
  # Lector. As you add validations to Lector, be sure to
  ...
  # LectoresController. Be sure to keep this updated too.
  def valid_session
    {}
  end

  describe "GET index" do
    it "assigns all lectores as @lectores" do
      lector = Lector.create! valid_attributes
      get :index, {}, valid_session
      assigns(:lectores).should eq([lector])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested lector as @lector" do
      ...
      assigns(:lector).should eq(lector)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new lector as @lector" do
      ...
      assigns(:lector).should be_a_new(Lector)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created lector as @lector" do
        post :create, {:lector => valid_attributes}, valid_session
        assigns(:lector).should be_a(Lector)
        assigns(:lector).should be_persisted
      end

      it "redirects to the created lector" do
        post :create, {:lector => valid_attributes}, valid_session
        response.should redirect_to(Lector.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved lector as @lector" do
        ...
        post :create, {:lector => {}}, valid_session
        assigns(:lector).should be_a_new(Lector)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested lector" do
        lector = Lector.create! valid_attributes
        # Assuming there are no other lectores in the database, this
        # specifies that the Lector created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Lector.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => lector.to_param, :lector => {'these' => 'params'}}, valid_session
      end
      ...
      it "redirects to the lector" do
        lector = Lector.create! valid_attributes
        put :update, {:id => lector.to_param, :lector => valid_attributes}, valid_session
        response.should redirect_to(lector)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the lector as @lector" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Lector.any_instance.stub(:save).and_return(false)
        put :update, {:id => lector.to_param, :lector => {}}, valid_session
        assigns(:lector).should eq(lector)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the lectores list" do
      lector = Lector.create! valid_attributes
      delete :destroy, {:id => lector.to_param}, valid_session
      response.should redirect_to(lectores_url)
    end
  end
